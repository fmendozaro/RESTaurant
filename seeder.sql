...
INSERT INTO users (username, password, email, first_name, last_name, phone) values('fer', '$2a$12$y1PuMP6jM189HfGcMgvPPeykOzJnPMtuhYphFx3oWB.KgCzNo47Su', 'fernando@codeup.com', 'Fernando', 'Mendoza', '2101234567');
INSERT INTO users (username, password, email, first_name, last_name, phone) values('luis', '$2a$12$y1PuMP6jM189HfGcMgvPPeykOzJnPMtuhYphFx3oWB.KgCzNo47Su', 'luis@codeup.com', 'Luis', 'Montealegre', '2101234568');
INSERT INTO users (username, password, email, first_name, last_name, phone) values('zach', '$2a$12$y1PuMP6jM189HfGcMgvPPeykOzJnPMtuhYphFx3oWB.KgCzNo47Su', 'zach@codeup.com', 'Zach', 'Gulde', '2101234569');
